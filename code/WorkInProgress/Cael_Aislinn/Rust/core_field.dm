...
/obj/effect/rust_em_field/proc/AddEnergy(var/a_energy, var/a_mega_energy, var/a_frequency)
	...
	//For debugging
//	var/debug_energy_gain = a_energy - (a_energy * energy_loss_ratio)
//	var/debug_mega_energy_gain = a_mega_energy - a_mega_energy * energy_loss_ratio
//	world << "EM Field gain: [debug_mega_energy_gain]. Energy Gain: [debug_energy_gain]. Frequency: [a_frequency]. Mega_Energy: [a_mega_energy]. Energy Loss Ratio: [energy_loss_ratio]."
