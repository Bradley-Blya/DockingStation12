...
/client/proc/cmd_admin_dress(var/mob/living/carbon/human/M in mob_list)
	...
	var/list/dresspacks = list(
		...
		"nanotrasen officer",
		"nanotrasen captain",
		"nanotrasen representative armor",
		"nanotrasen elite armor",
		"Martyred Lady",
		"Blood Angel"
		)
	...
	switch(dresscode)
		...
		if("nanotrasen representative armor")
			M.equip_to_slot_or_del(new /obj/item/clothing/under/rank/centcom_officer/wgun(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/swat(M), slot_shoes)
			M.equip_to_slot_or_del(new /obj/item/clothing/gloves/swat/salus/nt_sr(M), slot_gloves)
			M.equip_to_slot_or_del(new /obj/item/device/radio/headset/salus/nt(M), slot_l_ear)
//			M.equip_to_slot_or_del(new /obj/item/weapon/gun/energy/gun(M), slot_belt)
			M.equip_to_slot_or_del(new /obj/item/clothing/glasses/meson(M), slot_glasses)
			M.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/satchel(M), slot_back)
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/space/salus/admin/ntrep(M), slot_wear_suit)
			M.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/space/salus/admin/ntrep(M), slot_head)
			M.equip_to_slot_or_del(new /obj/item/clothing/mask/breath(M), slot_wear_mask)
//			M.equip_to_slot_or_del(new /obj/item/weapon/tank/emergency_oxygen(M), slot_s_store)

			var/obj/item/device/pda/heads/salus/ntrep/pda = new(M)
			pda.owner = M.real_name
			pda.ownjob = "NanoTrasen Representative"
			pda.name = "PDA-[M.real_name] ([pda.ownjob])"
			...
			W.access = get_all_accesses()
			W.access += get_all_centcom_access()
			W.assignment = "NanoTrasen Representative"
			W.registered_name = M.real_name
			M.equip_to_slot_or_del(W, slot_wear_id)

		if("nanotrasen elite armor")
			M.equip_to_slot_or_del(new /obj/item/clothing/under/rank/centcom_officer/wgun(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/swat(M), slot_shoes)
			M.equip_to_slot_or_del(new /obj/item/clothing/gloves/swat/salus/nt_sr(M), slot_gloves)
			M.equip_to_slot_or_del(new /obj/item/device/radio/headset/salus/nt(M), slot_l_ear)
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/glasses/meson(M), slot_glasses)
			M.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/satchel(M), slot_back)
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/space/salus/admin/ntarmor(M), slot_wear_suit)
			M.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/space/salus/admin/ntarmor(M), slot_head)
			M.equip_to_slot_or_del(new /obj/item/clothing/mask/breath(M), slot_wear_mask)
//			M.equip_to_slot_or_del(new /obj/item/weapon/tank/admin_tank(M), slot_s_store)

			var/obj/item/device/pda/heads/salus/ntelite/pda = new(M)
			pda.owner = M.real_name
			pda.ownjob = "NanoTrasen Elite Operative"
			pda.name = "PDA-[M.real_name] ([pda.ownjob])"
			...
			W.access = get_all_accesses()
			W.access += get_all_centcom_access()
			W.assignment = "NanoTrasen Elite Operative"
			W.registered_name = M.real_name
			M.equip_to_slot_or_del(W, slot_wear_id)
		...
		if("Martyred Lady")
			M.equip_to_slot_or_del(new /obj/item/clothing/under/rank/centcom_officer/wgun(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/salus/admin/sisarmor(M), slot_shoes)
			M.equip_to_slot_or_del(new /obj/item/clothing/gloves/salus/admin/sisarmor(M), slot_gloves)
			M.equip_to_slot_or_del(new /obj/item/device/radio/headset/salus/nt(M), slot_l_ear)
			M.equip_to_slot_or_del(new /obj/item/weapon/storage/belt/utility/full(M), slot_belt)
			M.equip_to_slot_or_del(new /obj/item/clothing/glasses/meson(M), slot_glasses)
			M.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/salus/admin/sisarmor/pwrpack(M), slot_back)
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/space/salus/admin/sisarmor(M), slot_wear_suit)
			M.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/space/salus/admin/sisarmor(M), slot_head)
			M.equip_to_slot_or_del(new /obj/item/clothing/mask/breath(M), slot_wear_mask)
//			M.equip_to_slot_or_del(new /obj/item/weapon/tank/admin_tank(M), slot_s_store)

			var/obj/item/device/pda/heads/salus/ntelite/pda = new(M)
			pda.owner = M.real_name
			pda.ownjob = "NanoTrasen Martyred Lady Operative"
			pda.name = "PDA-[M.real_name] ([pda.ownjob])"
			...
			W.access = get_all_accesses()
			W.access += get_all_centcom_access()
			W.assignment = "NanoTrasen Martyred Lady Operative"
			W.registered_name = M.real_name
			M.equip_to_slot_or_del(W, slot_wear_id)
		...
		if("Blood Angel")
			M.equip_to_slot_or_del(new /obj/item/clothing/under/rank/centcom_officer/wgun(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/salus/admin/spacemarine(M), slot_shoes)
			M.equip_to_slot_or_del(new /obj/item/clothing/gloves/salus/admin/spacemarine(M), slot_gloves)
			M.equip_to_slot_or_del(new /obj/item/device/radio/headset/salus/nt(M), slot_l_ear)
			M.equip_to_slot_or_del(new /obj/item/weapon/storage/belt/utility/full(M), slot_belt)
			M.equip_to_slot_or_del(new /obj/item/clothing/glasses/meson(M), slot_glasses)
			M.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/salus/admin/spacemarine/pwrpack(M), slot_back)
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/space/salus/admin/spacemarine(M), slot_wear_suit)
			M.equip_to_slot_or_del(new /obj/item/clothing/head/helmet/space/salus/admin/spacemarine(M), slot_head)
			M.equip_to_slot_or_del(new /obj/item/clothing/mask/breath(M), slot_wear_mask)
//			M.equip_to_slot_or_del(new /obj/item/weapon/tank/admin_tank(M), slot_s_store)

			var/obj/item/device/pda/heads/salus/ntelite/pda = new(M)
			pda.owner = M.real_name
			pda.ownjob = "NanoTrasen Blood Angel Operative"
			pda.name = "PDA-[M.real_name] ([pda.ownjob])"
			...
			W.access = get_all_accesses()
			W.access += get_all_centcom_access()
			W.assignment = "Nanotrasen Blood Angel Operative"
			W.registered_name = M.real_name
			M.equip_to_slot_or_del(W, slot_wear_id)
