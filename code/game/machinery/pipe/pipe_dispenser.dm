...
<b>Mains pipes:</b><BR>
<A href='?src=\ref[src];make_mains=0;dir=1'>Mains Pipe</A><BR>
<A href='?src=\ref[src];make_mains=1;dir=5'>Mains Bent Pipe</A><BR>
<A href='?src=\ref[src];make_mains=2;dir=1'>Mains Pipe Cap</A><BR>
<A href='?src=\ref[src];make_mains=3;dir=1'>Mains Manifold</A><BR>
<A href='?src=\ref[src];make_mains=4;dir=1'>Mains 4-Way Manifold</A><BR>
<A href='?src=\ref[src];make_mains=6;dir=1'>Mains Split Pipe: Aux</A><BR>
<A href='?src=\ref[src];make_mains=7;dir=1'>Mains Split Pipe: Scrubbers</A><BR>
<A href='?src=\ref[src];make_mains=8;dir=1'>Mains Split Pipe: Supply</A><BR>
<A href='?src=\ref[src];make_mains=9;dir=1'>Mains 3-Way Split Pipe</A><BR>

"}

//Keeping this here for when I need it in the future. Just making this build stable.
/*
<A href='?src=\ref[src];make_mains=10;dir=1'>General Mains Pipe</A><BR>
<A href='?src=\ref[src];make_mains=11;dir=5'>General Mains Bent Pipe</A><BR>
<A href='?src=\ref[src];make_mains=13;dir=1'>General Mains Manifold</A><BR>
<A href='?src=\ref[src];make_mains=12;dir=1'>General Mains Pipe Cap</A><BR>
<A href='?src=\ref[src];make_mains=14;dir=1'>General Mains 4-Way Manifold</A><BR>
<A href='?src=\ref[src];make_mains=16;dir=1'>General Mains Split Pipe: Scrubbers</A><BR>
<A href='?src=\ref[src];make_mains=17;dir=1'>General Mains Split Pipe: Supply</A><BR>
<A href='?src=\ref[src];make_mains=18;dir=1'>General Mains 3-Way Split Pipe</A><BR>
*/
///// Z-Level stuff
...
/obj/machinery/pipedispenser/Topic(href, href_list)
	...
	if(href_list["make"])
		if(!wait)
			...
			spawn(10)
				wait = 0
	if(href_list["make_mains"])
		if(!wait)
			var/p_type = text2num(href_list["make_mains"])
			var/p_dir = text2num(href_list["dir"])
			var/obj/item/mains_pipe/P = new (/*usr.loc*/ src.loc, pipe_type=p_type, dir=p_dir)
			P.update()
			P.add_fingerprint(usr)
			wait = 1
			spawn(10)
