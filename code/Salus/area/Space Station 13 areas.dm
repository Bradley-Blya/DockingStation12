...
/*-----------------------------------------------------------------------------*/
/*
	Testing a possible solution to the issue of areas of the station not properly venting to space when a window is destroyed or the area
	is otherwise exposed to space.
...
/area/salus/rust_testing_area
	name = "\improper R-UST Tokamak Testing Area"
	icon_state = ""

/area/salus/rust_testing_area/engine/core/one
	name = "\improper R-UST Engine Core One"
	icon_state = "prototype_engine"

/area/salus/rust_testing_area/engine/core/two
	name = "\improper R-UST Engine Core Two"
	icon_state = "prototype_engine"

/area/salus/rust_testing_area/engine/cooling/main_pipe
	name = "\improper R-UST Engine Cooling Piping"
	icon_state = "purple"

/area/salus/rust_testing_area/engine/atmospherics
	name = "\improper R-UST Engine Atmospherics"
	icon_state = "atmos"

/area/salus/rust_testing_area/engine/smes
	name = "\improper R-UST Engine SMES"
	icon_state = "engine_smes"

/area/salus/rust_testing_area/engine/matter_storage
	name = "\improper R-UST Engine Fuel Storage"
