//This file is named mainspipe2 because it's a file for the mainspipe, but with only a scrubbers and supply pipe
//Basically just have to remove the aux pipe from this, so that the pipe can be used for the majority of the station
obj/machinery/atmospherics/mains_pipe/salus/general
...
obj/machinery/atmospherics/mains_pipe/salus/general/simple
	name = "mains pipe"
	desc = "A one meter section of 2-line mains pipe"
...
obj/machinery/atmospherics/mains_pipe/salus/general/manifold
	name = "manifold pipe"
...
obj/machinery/atmospherics/mains_pipe/salus/general/manifold4w
	name = "manifold pipe"
	desc = "A manifold composed of mains pipes"
...
obj/machinery/atmospherics/mains_pipe/salus/general/split
	name = "mains splitter"
...
obj/machinery/atmospherics/mains_pipe/salus/general/split3
	name = "triple mains splitter"
	desc = "A splitter for connecting to the 2 pipes on a mainline."
...
obj/machinery/atmospherics/mains_pipe/salus/general/cap
	name = "pipe cap"
