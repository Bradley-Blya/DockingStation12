//Might be necessary because of the amount of entries required to spawn in the different varients of the mainspipes, and I don't want to clog up
// the pipe dispenser. Though, I could always just make a category for it in the regular one and have them all in there.

/obj/machinery/salus/mainspipe_dispenser
	name = "Pipe Dispenser"
