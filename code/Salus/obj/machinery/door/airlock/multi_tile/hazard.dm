...
/obj/machinery/door/firedoor/salus/multi_tile/New()
	. = ..()
	...
	spawn_filler_objects()
	setDensity(src.density)
	setOpac(src.opacity)


/obj/machinery/door/firedoor/salus/multi_tile/Del()
	for(var/area/A in areas_added)
		A.all_doors.Remove(src)
	. = ..()


/obj/machinery/door/firedoor/salus/multi_tile/examine()
	set src in view()
	. = ..()
...
/obj/machinery/door/firedoor/salus/multi_tile/Bumped(atom/AM)
	if(p_open || operating)
		return
	if(!density)
		return ..()
...
/obj/machinery/door/firedoor/salus/multi_tile/power_change()
	if(powered(ENVIRON))
		stat &= ~NOPOWER
	else
		stat |= NOPOWER
...
/obj/machinery/door/firedoor/salus/multi_tile/attack_hand(mob/user as mob)
...
/obj/machinery/door/firedoor/salus/multi_tile/attackby(obj/item/weapon/C as obj, mob/user as mob)
	add_fingerprint(user)
	if(operating)
		return//Already doing something.
...
/obj/machinery/door/firedoor/salus/multi_tile/latetoggle()
...
/obj/machinery/door/firedoor/salus/multi_tile/close()
	src.setOpac(1)
	latetoggle()
	return ..()

/obj/machinery/door/firedoor/salus/multi_tile/open()
	src.setOpac(0)
	latetoggle()
	return ..()


/obj/machinery/door/firedoor/salus/multi_tile/do_animate(animation)
	switch(animation)
		if("opening")
...
/obj/machinery/door/firedoor/salus/multi_tile/update_icon()
	overlays.Cut()
	if(density)
